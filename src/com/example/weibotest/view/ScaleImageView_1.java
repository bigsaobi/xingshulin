 ...
 * 
 */
public class ScaleImageView_1 extends ImageView {
	...
	public ScaleImageView_1(Context context) {
		super(context);
		init();
	}

	public ScaleImageView_1(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init();
	}

	public ScaleImageView_1(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
